...
- **open_questions:** Array of `{id: Q<N>, question: <text>, source_item: <ref>}`.
- **answers_received:** This field is **orchestrator-populated** after the human
  pause, not generated by you. Emit it as an empty list `[]`. The orchestrator
  fills it with user answers keyed by question ID on resume.
